...
export const HLJLD_COLUMNS: ReadonlyArray<{ key: string; className: string; width: string }> = [
  ...
  { key: 'med-name', className: 'col-med-name', width: '7.5%' },
  { key: 'med-amount', className: 'col-med-amount', width: '4%' },
  { key: 'med-route', className: 'col-med-route', width: '3.5%' },
  { key: 'enteral-name', className: 'col-enteral-name', width: '6.5%' },
  { key: 'enteral-amount', className: 'col-enteral-amount', width: '4%' },
  { key: 'enteral-route', className: 'col-enteral-route', width: '3.5%' },
  { key: 'urine', className: 'col-urine', width: '3.5%' },
  { key: 'ultrafiltration', className: 'col-ultrafiltration', width: '3.5%' },
  { key: 'output-name', className: 'col-output-name', width: '5%' },
  { key: 'output-amount', className: 'col-output-amount', width: '3.5%' },
  { key: 'drain-name', className: 'col-drain-name', width: '5%' },
...
/** 页码 = 本次任务内的页序，从 1 开始 */
export function formatHljld2PageNo(indexInJob: number): string {
 ...
 * 同输入必定同输出。
 */
export function paginateHljld2(
  doc: Document,
  host: HTMLElement,
  vm: HljldViewModel,
  remarkLines: string[],
...
export function countHljldPages(
  ...
  return paginateHljld2(doc, host, vm, remarkLines).length;
}
 ...
 */
export function addTrailingBlankRows2(root: HTMLElement, doc: Document): void {
