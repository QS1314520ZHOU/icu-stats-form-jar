...
import { Hljld2PdfService, PageIndexInfo } from './hljld2-pdf.service';
import { PatientContext } from './hljld2-form.models';
...
export class Hljld2FormPdfComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private readonly hljldService: Hljld2FormService,
    private readonly pdfService: Hljld2PdfService,
