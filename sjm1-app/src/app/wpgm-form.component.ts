...
export class WpgmFormComponent implements OnInit, OnDestroy {
  readonly categories: SupplyCategory[] = ['常规', '特殊', '专科', '皮肤护理'];
  ...
  items: SupplyItem[] = [
    ...
    { id:'soft-pillow', category:'常规', name:'小软枕', quantity:'2个', specification:'30CM*40CM', purpose:'抬高双手、减轻水肿', selected:false },
    { id:'restraint-gloves', category:'常规', name:'约束手套', quantity:'2个', specification:'手套样式（带拉链)', purpose:'防止意外拔管', selected:false },
    { id:'water-pad', category:'常规', name:'水垫', quantity:'1个', specification:'48cm*35cm及以上尺寸', purpose:'皮肤减压', selected:false },
    { id:'foam-dressing', category:'常规', name:'泡沫敷贴', quantity:'2-3张', specification:'（无边型）10cm*10cm及以上', purpose:'皮肤减压', selected:false },
    { id:'nursing-pad', category:'常规', name:'护理垫', quantity:'1-2包', specification:'60cm*90cm', purpose:'大小便护理', selected:false },
    { id:'cup', category:'常规', name:'杯子', quantity:'1个', specification:'透明带刻度', purpose:'装水', selected:false },
    { id:'bowl', category:'常规', name:'碗', quantity:'1个', specification:'带盖可进微波炉', purpose:'盛装食物', selected:false },
    { id:'basin', category:'常规', name:'盆子', quantity:'2个', specification:'盆子高度<15CM', purpose:'洗脸、擦浴', selected:false },
    { id:'towel', category:'常规', name:'毛巾', quantity:'2张', specification:'/', purpose:'洗脸、擦浴', selected:false },
    { id:'disinfect-wipes', category:'常规', name:'消毒湿巾', quantity:'1包', specification:'消毒湿巾或75%酒精湿巾', purpose:'消毒个人物品', selected:false },
    { id:'tissue', category:'常规', name:'抽纸', quantity:'4-5包', specification:'/', purpose:'皮肤清洁', selected:false },
    { id:'wet-wipes', category:'常规', name:'卫生湿巾', quantity:'1-2包', specification:'/', purpose:'皮肤清洁', selected:false },
    { id:'razor', category:'常规', name:'剃须刀（男性患者）', quantity:'1个', specification:'安全型', purpose:'个人护理', selected:false },
    ...
    { id:'milk', category:'特殊', name:'牛奶', quantity:'4-5盒', specification:'纯牛奶', purpose:'提供能量与营养', selected:false },
    { id:'rice-powder', category:'特殊', name:'米粉', quantity:'1盒', specification:'婴儿米粉', purpose:'提供能量与营养', selected:false },
    { id:'lotion', category:'特殊', name:'润肤乳', quantity:'1瓶', specification:'/', purpose:'滋润皮肤', selected:false },
    { id:'lip-balm', category:'特殊', name:'润唇膏', quantity:'1支', specification:'安全型', purpose:'滋润口唇', selected:false },
    { id:'urinal', category:'特殊', name:'尿壶', quantity:'1个', specification:'容积：1000ml及以上 男性:带盖带有刻度,手提把手式;女性：扁平式', purpose:'排泄护理', selected:false },
    { id:'comb', category:'特殊', name:'梳子（女性患者）', quantity:'1把', specification:'/', purpose:'头发护理', selected:false },
    ...
    { id:'rhubarb', category:'专科', name:'大黄', quantity:'按科室要求', specification:'/', purpose:'清肠解毒、改善腹胀、控制感染', selected:false },
    { id:'mirabilite', category:'专科', name:'芒硝', quantity:'按科室要求', specification:'/', purpose:'清肠解毒、改善腹胀、控制感染', selected:false },
    { id:'mirabilite-bag', category:'专科', name:'芒硝袋', quantity:'10个', specification:'/', purpose:'装芒硝敷腹部', selected:false },
    { id:'strainer', category:'专科', name:'漏勺', quantity:'1个', specification:'/', purpose:'过滤大黄', selected:false },
    { id:'herbal-bowl', category:'专科', name:'碗', quantity:'1个', specification:'带盖、1000ml及以上容量', purpose:'浸泡大黄', selected:false },
    ...
    { id:'abdominal-belt', category:'专科', name:'腹带', quantity:'1根', specification:'60kg体重以下中号，以上L号', purpose:'减轻伤口疼痛、促进愈合', selected:false },
    { id:'chest-band', category:'专科', name:'多头胸带', quantity:'1根', specification:'改良款', purpose:'固定胸廓，纠正反常呼吸，改善通气', selected:false },
    { id:'tampon', category:'皮肤护理', name:'卫生棉条（量多型）', quantity:'1盒', specification:'/', purpose:'用于大便失禁患者', selected:false },
    { id:'skin-deglazer', category:'皮肤护理', name:'皮肤除胶剂', quantity:'1瓶', specification:'/', purpose:'温和去除胶渍、保护皮肤', selected:false },
    { id:'skin-protective-film', category:'皮肤护理', name:'皮肤保护膜', quantity:'1瓶', specification:'/', purpose:'滋润、保护皮肤', selected:false },
    { id:'stoma-powder', category:'皮肤护理', name:'造口粉', quantity:'1瓶', specification:'/', purpose:'吸收渗液、减轻刺激', selected:false },
  ];
  ...
  private paginate(): void {
    ...
    const FOOTER_LINES = [
      '以上患者所需物品请家属自行准备，科室及工作人员不销售任何物品，住院期间如患者生活物品数量不足、病情变化或转科等情况，医护人员会电话通知您，请务必保持电话通畅！如有需要请拨打科室咨询电话：023-81915173。',
      '探视提醒：重症医学科(ICU)实行24小时无陪护制度，每日探视时间为11:00—11:30，每位患者探视人数不超过2人，具体探视要求请参照《重症医学科探视制度》规定。',
      '',
      '',
      '重症医学科',
    ];
  ...
  print(): void {
    ...
    pw.document.write('<!DOCTYPE html><html lang="zh-CN"><head><meta charset="utf-8"><title>ICU住院患者物品准备清单</title><style>' + componentStyles + '</style><style>' + printCss + '</style></head><body>' + body + '</body></html>');
    pw.document.close();
