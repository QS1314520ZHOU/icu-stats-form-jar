...
@Component({
  standalone: false,
  selector: 'app-hljld-form-pdf-new',
  templateUrl: './hljld-form-pdf-new.component.html',
  styleUrls: ['./hljld-form-pdf-new.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HljldFormPdfNewComponent implements OnInit, OnDestroy {
