...
/**
 * 患者时间字段解析工具（严格模式）（/form/hljldFormPDFNew 专用）。
 *
 ...
 */
public final class HljldPatientTimeResolverNew {

    private static final Logger log = LoggerFactory.getLogger(HljldPatientTimeResolverNew.class);
    ...
    private HljldPatientTimeResolverNew() {}
